...
const DARK_GLASS: ThemePreset = {
  ...
  tokens: {
    ...
    '--text-primary': '#e8edf5',
    '--text-muted': 'rgba(148, 163, 184, 0.62)',
...
const LIGHT_MATTE: ThemePreset = {
  ...
  tokens: {
    ...
    '--text-muted': 'rgba(60, 60, 60, 0.55)',
    '--text-faint': 'rgba(60, 60, 60, 0.42)',
...
const LIGHT_FROSTED: ThemePreset = {
  ...
  tokens: {
    ...
    '--text-muted': 'rgba(80, 70, 60, 0.55)',
    '--text-faint': 'rgba(80, 70, 60, 0.42)',
