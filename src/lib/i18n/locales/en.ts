...
const en: LocaleMessages = {
  workspace: { scope: { temporary: 'Inbox', all: 'All', saved: 'Saved' }, kind: { text:'Text',image:'Image',file:'File',credential:'Credential',bookmark:'Bookmark',note:'Note' }, searchPlaceholder:'Search all content',temporaryRetention:'Temporary content is cleaned up according to settings',createText:'New text',save:'Save',unsave:'Remove from saved',delete:'Delete',undo:'Undo',allKinds:'All types',copy:'Copy',copied:'Copied',temporary:'Temporary',savedLabel:'Saved',cleanupUntil:'Keep until',clearSearch:'Clear search',searching:'Searching',kindFilter:'Content type',results:'results',pasteHint:'You can also paste or drop files',noResults:'No matching content',noContent:'No content yet',loadingDetail:'Loading details…',back:'Back',edit:'Edit',rename:'Rename',cancel:'Cancel',unavailableImage:'Image unavailable',unavailableFile:'File unavailable',usefulInformation:'Information to use',notes:'Notes',tags:'Tags',openLink:'Open link',reveal:'Reveal',hide:'Hide',notices:{saved:'Saved',unsaved:'Moved to Inbox',deleted:'Deleted',deleteFailedRestored:'Delete failed; content restored',undoExpired:'Undo expired',copyFailed:'Copy failed',refreshFailed:'Refresh failed',deletedRemotely:'This content was deleted in another window',restored:'Restored',undoFailed:'Undo failed',detailLoadFailed:'Failed to load details'},contentMissing:'Content no longer exists',openItem:'Open {title}',dragToReorder:'Drag to reorder',untitled:'Untitled',resultsFound:'{n} results',itemsCount:'{n} items',emptyInbox:'Inbox is empty',emptySaved:'Nothing saved yet',emptyAll:'No content yet',emptySearchHint:'Try a shorter keyword or clear the type filter',emptyInboxHint:'Paste text, a screenshot, or drop files to get started',title:'Title',body:'Content',noteBody:'Body',saveEdit:'Save',updated:'Updated',editText:'Edit text',revealInFolder:'Open file location',editNote:'Edit note',detailLabel:'Content details',linkLabel:'Link',storeAction:'Store',composeHint:'Ctrl+Enter to store · Esc to cancel' },
  nav: {
    home: 'Dock',
    all: 'All',
    favorites: 'Favorites',
  ...
  quickAccess: {
    ...
    aiTruncated: 'Output was truncated after an automatic retry',
    aiAuthFailed: 'The API key is invalid or expired',
    aiRateLimited: 'Request rate limited; try again shortly',
    aiTimedOut: 'Request timed out; check the network and retry',
    aiNetworkFailed: 'Network request failed; try again shortly',
  ...
  aiSettings: {
    ...
    thinkingMode: 'Enable thinking mode (DeepSeek)',
  ...
  settings: {
    ...
    exportHint: 'Export everything you have stored to a file for backup or migration to other apps.',
    exportFormat: 'Format',
    exportSensitive: 'Include sensitive fields',
    exportSensitiveHint: 'When off, sensitive values such as passwords are replaced with ******.',
    exportAction: 'Choose location & export',
    exporting: 'Exporting...',
    exportDone: 'Exported {n} items',
    exportFailed: 'Export failed',
    exportReveal: 'Reveal in folder',
    exportSaveTitle: 'Export data',
  },
  toast: {
